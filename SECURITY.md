...
2. **Email:** Send an email directly to `snw-mint@outlook.com` with the details of the vulnerability, steps to reproduce (Proof of Concept), and the expected impact.
